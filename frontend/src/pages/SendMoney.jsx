        ...
        <div className="h-full flex flex-col justify-center">
            ...
            >
                ...
                <div className="space-y-4">
                    ...
                    <button onClick={() => navigate("/dashboard")} className="justify-center rounded-md text-sm font-medium ring-offset-background transition-colors h-10 px-4 py-2 w-full bg-red-500 text-white">Go Back</button>
                </div>
                </div>
        </div>
      </div>
